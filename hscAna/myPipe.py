...
class MyPipe(object):
    """
    General class for interacting with outputs from the HSC pipeline.
    ...
    def get_sigma(self):
        ...
        """
        var = self.maskedImg.getVariance().getArray().copy()
        return np.sqrt(var)
